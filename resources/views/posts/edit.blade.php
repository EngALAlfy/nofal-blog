        ...
        <div class="container">
            <div class="row">
                <div class="col-12 p-t-30">
                    <form action="{{ route('posts.update' , $post) }}" enctype="multipart/form-data" method="post" class="">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  id="content" name="content"
                                               rows="9"
                                               class=" form-control" placeholder="@lang('placeholders.info')">{!! $post->content !!}</textarea>
                                </div>
